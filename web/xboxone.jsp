...
<% try {
                                   ...
                                   // DBCollection Login = db.getCollection("Login2");
                                    ...
                                    searchQuery1.put("cakeunit", cakeunit);
                ...
                String cakeprice = obj1.getString("cakeprice");
                 cakeunit = obj1.getString("cakeunit");
...
<body color="#FDF5E6">
<FORM ACTION="addproduct.jsp" align="right top">
            <INPUT TYPE="SUBMIT" VALUE="Back" class="btn btn-info1 active" > 
             
             </FORM>
        <FORM ACTION="addtocart.jsp" align="right">
            <INPUT TYPE="HIDDEN" NAME="cancel" VALUE="1" >
            <INPUT TYPE="text" NAME="numItems" hidden VALUE="1" >
            <INPUT TYPE="HIDDEN" NAME="cakename" VALUE="<%=cakename%>" >
             <INPUT TYPE="HIDDEN" NAME="cakeunit" VALUE="<%=cakeunit%>" >
              <INPUT TYPE="HIDDEN" NAME="cakeprice" VALUE="<%=cakeprice%>">
               ...
               <INPUT TYPE="HIDDEN" NAME="caketype" VALUE="<%=caketype%>"  >
               <H1><%=cakename%></H1></br>
               <H2>Quantity: <%=cakeunit%></H2></br><H2>Price: US <%=cakeprice%></H2>
            <img src="<%=cakeimage%>" width="230" height="237" alt="" class="photo_hover3">
            <INPUT TYPE="SUBMIT" VALUE="Add to Shopping Cart" class="btn btn-info1 active" > 
