...
<div class="span4">
    ...
    <li><a href="aboutus.html">Location & Hours</a></li>
    <li><a href="testimonial.html">Reviews & Testimonials</a></li>
        ...
        <section class="group<%=i%>">
            ...
            <form  method = "post" action = "xboxone.jsp?cakeunit=<%=cakeunit%>&&cakename=<%=cakename%>">
                <input class = "button" type = "submit" name = "cakename" value = "Buy">
                 ...
                 <form  method = "post" action = "rev.jsp?cakeunit=<%=cakeunit%>&&cakename=<%=cakename%>&&user=<%=searchParameterUserName%>&&cakeprice=<%=cakeprice%>&&cakecategory=<%=cakecategory%>&&caketype=<%=caketype%>">
